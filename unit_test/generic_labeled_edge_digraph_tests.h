#ifndef GRAPHDOM_GENERIC_LABELED_EDGE_DIGRAPH_TESTS_H
#define GRAPHDOM_GENERIC_LABELED_EDGE_DIGRAPH_TESTS_H
...
#define LABELED_EDGE_DIGRAPH_CORRECT_EDGE_INSERTION_WITH_LABEL_WITHOUT_REPETITIONS_LVALUE_VERTEX_HANDLE_ADJ_LIST_NOT_C_METHODS_TEST(TEST_SUITE_NAME,CONCRETE_CLASS_NAME)                                        \
                ...
                for(std::size_t k = 0; k < inserted_vertices_and_incidence_matrix.size(); ++k){                                                                                                                 \
                    ...
                    for(auto edge_itr = k_adj_list.begin(); edge_itr != k_adj_list.end(); ++edge_itr){                                                                                                          \
                        ...
                        EXPECT_NE( ( *edge_itr_label_raw_pointer_to_const ).get_as_pointer() , first_edge_label_inserted_pair_raw_pointer );                                                                    \
                                                                                                                                                                                                                \
                        EXPECT_EQ(                                                                                                                                                                              \
                            ( ( *edge_itr_label_raw_pointer_to_const ).get_as_reference() ).first ,                                                                                                             \
                            &( *( ( inserted_vertices_and_incidence_matrix[ k ] ).first ) )                                                                                                                     \
                        );                                                                                                                                                                                      \
                        EXPECT_EQ(                                                                                                                                                                              \
                            ( ( *edge_itr_label_raw_pointer_to_const ).get_as_reference() ).second ,                                                                                                            \
                            edge_itr_vertex_raw_pointer                                                                                                                                                         \
                        );                                                                                                                                                                                      \
                    }                                                                                                                                                                                           \
...
#endif //GRAPHDOM_GENERIC_LABELED_EDGE_DIGRAPH_TESTS_H