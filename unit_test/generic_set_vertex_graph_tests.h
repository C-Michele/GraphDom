...
#define SET_VERTEX_GRAPH_UNABLE_TO_CONVERT_A_VERTEX_POINTER_TO_MULTISET_VERTEX_POINTER_TEST(TEST_SUITE_NAME,CONCRETE_CLASS_NAME)                                                                                                                                                        \
    TEST(TEST_SUITE_NAME, unable_to_convert_a_vertex_pointer_to_multiset_vertex_pointer) {                                                                                                                                                                                              \
        ...
        for(std::size_t i = 0; i < number_of_vertices; ++i) {                                                                                                                                                                                                                           \
            ASSERT_THROW(const typename MAIN_LIBRARY_NAMESPACE::multiset_vertex_graph<std::size_t>::VERTEX_PTR_NAME multiset_vertex_ptr_i = static_cast<MAIN_LIBRARY_NAMESPACE::multiset_vertex_graph<std::size_t>::VERTEX_PTR_NAME>(( inserted_vertices[i] ).first), std::exception);  \
        }                                                                                                                                                                                                                                                                               \
    }                                                                                                                                                                                                                                                                                   \
