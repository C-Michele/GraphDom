...
class MAIN_LIBRARY_NAMESPACE::multiset_vertex_graph<VertexType>::VERTEX_PTR_NAME final {
    public:
        ...
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::multiset_vertex_graph<VertexType>::ADJ_LIST adj_list(typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::edge_type) const;
        template <typename Compare>
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::multiset_vertex_graph<VertexType>::ADJ_LIST adj_list(typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::edge_type, Compare comp) const;
        ...
        [[nodiscard]] typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::CONSTANT_ADJ_LIST const_adj_list(typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::edge_type) const;
        template <typename Compare>
        [[nodiscard]] typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::CONSTANT_ADJ_LIST const_adj_list(typename MAIN_LIBRARY_NAMESPACE::graph<VertexType>::edge_type, Compare comp) const;
