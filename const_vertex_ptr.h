...
class MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::CONSTANT_VERTEX_PTR_NAME final {
    public:
        CONSTANT_VERTEX_PTR_NAME() = delete;
        CONSTANT_VERTEX_PTR_NAME(const CONSTANT_VERTEX_PTR_NAME&);
        CONSTANT_VERTEX_PTR_NAME(MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::VERTEX_PTR_NAME&);
        ...
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::CONSTANT_EDGE_ITERATOR_NAME begin() const;
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::CONSTANT_EDGE_ITERATOR_NAME end() const;
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::CONSTANT_EDGE_ITERATOR_NAME begin(MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::edge_type) const;
        [[nodiscard]] MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::CONSTANT_EDGE_ITERATOR_NAME end(MAIN_LIBRARY_NAMESPACE::graph_base<VertexType>::edge_type) const;
