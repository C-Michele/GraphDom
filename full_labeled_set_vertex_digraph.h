        ...
        private:
            class custom_set_less {
                public:
                    ...
                    bool operator()(
                        const typename graph<VertexType>::template non_mixed_graph_labeled_vertex_container<set_vertex_graph<VertexType>::VertexContainerPointerType,VertexLabelType>& left,
                        const typename graph<VertexType>::template non_mixed_graph_labeled_vertex_container<set_vertex_graph<VertexType>::VertexContainerPointerType,VertexLabelType>& right ) const {
            ...
            std::set<
                typename graph<VertexType>::template non_mixed_graph_labeled_vertex_container<set_vertex_graph<VertexType>::VertexContainerPointerType,VertexLabelType>,
                custom_set_less
            > vertices;
    };
}
