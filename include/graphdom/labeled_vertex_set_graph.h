...
namespace graphdom {
    ...
    template <typename VertexType, typename VertexLabelType, typename VertexLabellerType>
    std::pair<typename graph<VertexType>::vertex_handle,bool> labeled_vertex_set_graph<VertexType,VertexLabelType,VertexLabellerType>::insert_vertex(const VertexType& v_core) {
        return insert_vertex(v_core,vertices_labeller(v_core));
    }

    template <typename VertexType, typename VertexLabelType, typename VertexLabellerType>
    std::pair<typename graph<VertexType>::vertex_handle,bool> labeled_vertex_set_graph<VertexType,VertexLabelType,VertexLabellerType>::insert_vertex(VertexType&& v_core) {
