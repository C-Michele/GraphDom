...
namespace graphdom {
    ...
    class graph<VertexType>::adj_list_iterator final : public graph<VertexType>::adj_list_base_iterator< const graph<VertexType>::vertex_container* > {
        public:
             ...
             * If `*this` is valid and the "begin point" of `*this` belongs to a set graph, invoking this conversion operator via `*this` will throw an instance of a class publicly derived, directly or indirectly, from `std::exception`.
             *
             * @par Complexity
             * Constant.
             */
