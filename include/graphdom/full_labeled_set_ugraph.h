...
namespace graphdom {
    ...
    virtual public labeled_edge_non_mixed_graph<VertexType,EdgeLabelType,T2> {
        ...
        private:
            ...
            using edge_endpoint = typename graphdom::set_graph<VertexType>::template labeled_undirected_edge_endpoint<VertexLabelType>;
...
graphdom::full_labeled_set_ugraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::erase_edge(
    ...
    return graphdom::set_graph<VertexType>::edge_iterator_factory(
        this,
...
void graphdom::full_labeled_set_ugraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::insert_edge(
    ...
    auto const end_point_vertex_container = static_cast< const vertex_container* >( graphdom::graph<VertexType>::get_vertex_container( end_point_vertex_ptr ) );
