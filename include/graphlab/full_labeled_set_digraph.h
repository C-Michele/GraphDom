...
namespace MAIN_LIBRARY_NAMESPACE {
    ...
    virtual public labeled_edge_non_mixed_graph<VertexType,EdgeLabelType,T2> {
        public:
            ...
            using MAIN_LIBRARY_NAMESPACE::labeled_vertex_set_graph<VertexType,VertexLabelType,T1>::insert_vertex;
        ...
        private:
            using VertexContainerPointerType = typename MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::VertexContainerPointerType;
            using edge_endpoint = typename MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::template labeled_directed_edge_endpoint<VertexLabelType>;
            using adj_set = typename MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::adj_set;
            using vertex_container = typename MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::template non_mixed_graph_labeled_vertex_container<EdgeLabelType>;
...
MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::
full_labeled_set_digraph(const Compare& v_comp, const T1& v_lab, const T2& e_lab) :
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::~full_labeled_set_digraph() {
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
std::size_t MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::order() const {
    return vertices.size();
}

template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
const VertexLabelType& MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::get_vertex_label(
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
const EdgeLabelType& MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::get_edge_label(
    const typename graph<VertexType>::CONSTANT_EDGE_ITERATOR_NAME &) const {
    //TODO: real implementation
}

template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
void MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::erase_vertex(
...
MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::erase_edge(
    ...
    auto edge_itr_inner_iterator = MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::get_inner_iterator( edge_itr );
    auto const edge_itr_endpoint = *edge_itr_inner_iterator;
    safe_edge_endpoint_deallocation(edge_itr_endpoint);
    return MAIN_LIBRARY_NAMESPACE::set_graph<VertexType>::edge_iterator_factory(
        this,
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
VertexLabelType& MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::get_vertex_label(
...
MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::insert_vertex(
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
EdgeLabelType& MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::get_edge_label(
    const typename graph<VertexType>::CONSTANT_EDGE_ITERATOR_NAME&) {
    //TODO: real implementation
}

template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
void MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::insert_edge(
...
template<typename VertexType, typename VertexLabelType, typename EdgeLabelType, typename Compare, typename T1, typename T2>
void MAIN_LIBRARY_NAMESPACE::full_labeled_set_digraph<VertexType,VertexLabelType,EdgeLabelType,Compare,T1,T2>::
